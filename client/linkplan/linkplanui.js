...
import '/client/lib/utility/notification.js';
import {MapManager} from './mapmanager.js';
import {MulticastEvent} from '/common/lib/chimerapatterns'
import './portalui.js';

export class LinkPlanUi {
    constructor() {
        ...
        //Events
        this.onDrawLinesBetweenPortals = new MulticastEvent(this,'onDrawLinesBetweenPortals');
        this.onRemoveLine = new MulticastEvent(this,'onRemoveLine');
    }
    ...
    addLine({portal1, portal2 }) {
        ...
        this.onDrawLinesBetweenPortals.callEvent({portal1: portal1, portal2: portal2});
    }
    ...
    removeLine( lineIndex ) {
        ...
        this.onRemoveLine.callEvent(lineIndex);
    }
