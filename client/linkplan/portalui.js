...
export class PortalUi {
    constructor() {
        ...
        //Events
        this.onPortalClick = new MulticastEvent(this,'onPortalClick');
        this.onPortalHighlight = new MulticastEvent(this,'onPortalClick');
    }
    ...
    drawPortals(){
        ...
        self.mapManager.onLayerEvent({
            ...
            callback: function (features, eventData) {
                ...
                self.onPortalClick.callEvent(portal,true);
    ...
    portalLayerClick(features) {
        ...
        if (portal) this.onPortalClick.callEvent(portal);
    ...
    portalHighlight(portal, isHighlighted) {
        if (isHighlighted == true) {
            ...
            this.onPortalHighlight.callEvent(portal, true);
        }
        ...
        if (isHighlighted == false) {
            ...
            this.onPortalHighlight.callEvent(portal , false);
        }
    }
}
