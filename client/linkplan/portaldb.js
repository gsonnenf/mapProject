...
import '/common/collection/model_portal';
...
export class PortalDb {
     constructor() {
         ...
         //Events
         this.onRemoved = new MulticastEvent(this,'onRemoved', ['document','lastUpdateTime']);
         this.onChanged = new MulticastEvent(this,'onRemoved', ['document','lastUpdateTime']);
         this.onAdded = new MulticastEvent(this,'onRemoved', ['document','lastUpdateTime']);

         this.onReady = new MulticastEvent();
