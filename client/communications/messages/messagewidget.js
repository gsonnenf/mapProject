...
export class MessageWidget {
    constructor({inputElement,outputElement,submitButton }) {
        ...
        this.onSendMessage = new MulticastEvent(this,'onSendMessage');
    ...
    sendMessage() {
        this.onSendMessage.callEvent( this.inputElement.val() );
    ...
    printMessageList( messageList ){
        messageList.forEach( (message)=>{ this.printMessage( message ) });
    }
