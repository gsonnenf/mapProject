...
import {Observable} from '/common/lib/chimerapatterns'

export class MessageTabWidget {
    ...
    setActiveLinkPlan( linkPlan ) {
        ...
        //TODO:Fix this to work with new linkplan
        if (! linkPlan._id ) {
            Observable.setObservable(linkPlan, '_id').push( ()=> {
                Observable.removeObservable(linkPlan, '_id');
